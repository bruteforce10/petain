...
const ThreadRoot: FC<{ isEmpty: boolean }> = ({ isEmpty }) => {
  ...
  return (
    <ThreadPrimitive.Root
      // 👇 1. UBAH bg-background JADI bg-transparent
      ...
      >
        <div
          className={cn(
            ...
            // 👇 2. Cukup justify-end saja, JANGAN pakai pb-4 lagi di sini biar gak double padding
            isEmpty && "justify-end",
          )}
        >
          ...
          <ThreadPrimitive.ViewportFooter
            className={cn(
              // 👇 3. UBAH bg-background JADI bg-transparent dan rapikan padding
              "aui-thread-viewport-footer bg-transparent flex flex-col gap-4 overflow-visible pb-4",
              !isEmpty &&
...
const ThreadWelcome: FC = () => {
  return (
    <div className="aui-thread-welcome-root flex flex-col flex-1 h-full items-center justify-center px-4 text-center">

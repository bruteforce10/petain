  ...
  return (
    <AuthShell>
      ...
      <p className="mt-2 text-[15px] leading-relaxed text-teal-kedalaman">
        Mulai riset lokasi dan kompetitor untuk usahamu — cukup email dan
        password.
      </p>
      ...
      <form onSubmit={submit} className="mt-8 space-y-5">
        ...
        {info && (
          <p
            role="status"
            className="rounded-xl border border-hijau-sinyal/30 bg-mint-sorot/25 px-4 py-3 text-sm leading-relaxed text-hijau-rimba"
          >
            {info}
          </p>
        )}

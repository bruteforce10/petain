...
async function runAndPush(msg: RunAreaScrape): Promise<void> {
  try {
    ...
    console.log('[petain/content] scrape finished, places:', places.length, 'sample:', places[0]);
    ...
    console.log('[petain/content] scrape threw:', e);
